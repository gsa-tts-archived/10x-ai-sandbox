...
<section class="usa-banner" aria-label="Official website of the United States government">
	<div class="usa-accordion">
		<header class="usa-banner__header">
			<div class="usa-banner__inner {centered ? 'centered' : ''}">
				<div class="grid-col-auto">
					<img aria-hidden="true" class="usa-banner__header-flag" src={usFlagSmall} alt="" />
				</div>
		...
		<div
			class="usa-banner__content usa-accordion__content {bannerExpanded ? 'block' : 'hidden'}"
